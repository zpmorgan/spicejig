...
playGame.prototype = {
  preload: function(){
    ...
    game.load.onFileError.addOnce((key,file) => {
      ...
      notfound_html += "<br> <a class='menu-option' onclick='GUI.go_back_to_zone();'> Back </a>";
...
thumbzone.prototype = {
  ...
  create : function(){
    ...
    clickCallback = function(pointer, event){
...
GUI.disp_art_credits = function(){
  ...
  if(G.spec.t3){
    ...
    credit_html += '<br>'
    credit_html +=  "<a class='menu-option' onclick='GUI.go_back_to_zone();'> Back </a>";
  }
